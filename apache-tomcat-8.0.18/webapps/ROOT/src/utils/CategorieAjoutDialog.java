 ...
 * @version 1.0
 */
public class CategorieAjoutDialog extends javax.swing.JDialog {
  public CategorieAjoutDialog(Frame parent) {
    super(parent, true);
