 ...
 * @version 1.0
 */
public class RequeteExecutionDialog extends javax.swing.JDialog {
  public RequeteExecutionDialog(Frame parent) {
    super(parent, true);

    //{{INIT_CONTROLS
    setTitle("Execution requete");
    ...
    requete.setText("select * from LesCategories");
   ...
   * The user ID entered.
   */
  javax.swing.JTextField requete = new javax.swing.JTextField();
